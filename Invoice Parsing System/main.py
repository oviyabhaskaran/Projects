...
from functionality.layout_parser import recognize
...
def main():
    ...
    data = recognize(user_attr['endpoint_for_invoice_parser'], JSON_MSG)
    ...
    result = {
        ...
        'bot_name' : 'Invoice Parser Layout LMv3',
        'version' : '1.0',
    ...
    if not isinstance(data, type([])):
        ...
        dest = f"{user_attr['s3_input_stem']}".replace('ocr_outputs', 'parsed_outputs')+(op_path.parts[-1])
